...
// ===============================
// 📌 CRIA BOTOES DE FORMATAÇÃO GLOBAL
// ===============================
function criarBotoesFormatoGlobal() {
    const container = document.createElement('div');
    container.id = 'botoesFormatoGlobal';
    ...
    document.getElementById('colunasSelect').appendChild(container);
}

// Chama a função ao carregar a página
criarBotoesFormatoGlobal();
...
function exibirTabela(data) {
    ...
    for (let j = 0; j < numCols; j++) {
        ...
        th.title = "Clique para aplicar o formato selecionado";
